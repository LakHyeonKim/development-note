...
<figure><img src="../.gitbook/assets/image (1) (1) (1).png" alt=""><figcaption><p>[출처] <a href="https://www.redblobgames.com/grids/hexagons/">https://www.redblobgames.com/grids/hexagons/</a></p></figcaption></figure>

[react-hexgrid](https://www.npmjs.com/package/react-hexgrid?activeTab=readme) 라이브러리에서 제공하는 꼭지점이 위로 향했을 때 `q, r, s` 좌표계를 보자&#x20;

핵사곤 `q, r, s` 좌표 합은 항상 `0`이다.
...
### 핵사곤 수량이 증가 할 때 마다 Origin option 수정 필요
